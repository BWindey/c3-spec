This is the spec taken from c3-web. It needs to be verified, then moved into c3-spec.md

Remove parts that are moved into c3-spec.

<!-- toc -->

  * [Input Elements and Tokens](#input-elements-and-tokens)
  ...
  * [Raw string literals](#raw-string-literals)
    + [Compile time concatenation](#compile-time-concatenation)
    + [Source code pre-filtering](#source-code-pre-filtering)
  ...
  * [Any type](#any-type)
    + [Fields](#fields)
    + [Switching over `any`](#switching-over-any)
  * [Anyfault type](#anyfault-type)
- [Declarations and scope](#declarations-and-scope)
    + [Combined assign](#combined-assign)
    + [Implicit conversion](#implicit-conversion)
  * [Ternary, elvis and or-else expressions](#ternary-elvis-and-or-else-expressions)
    + [Ternary evaluation](#ternary-evaluation)
    + [Elvis evaluation](#elvis-evaluation)
    + [Orelse evaluation](#orelse-evaluation)
  * [Suffix expression](#suffix-expression)
    + [Effect of `?`](#effect-of-)
    + [Type of the expression](#type-of-the-expression)
  * [Rethrow expression](#rethrow-expression)
    + [The expression to rethrow](#the-expression-to-rethrow)
    + [Type](#type)
  * [Relational expression](#relational-expression)
  * [And expression](#and-expression)
    + [Type](#type-1)
  * [Or expression](#or-expression)
    + [Constant folded arithmetics](#constant-folded-arithmetics)
    + [Type](#type-2)
  * [Casts](#casts)
  * [Pointer casts](#pointer-casts)
    + [Integer to pointer cast](#integer-to-pointer-cast)
    + [Pointer to integer cast](#pointer-to-integer-cast)
  * [Subscript operator](#subscript-operator)
  * [Operands](#operands)
  * [Compound Literals](#compound-literals)
  * [Function calls](#function-calls)
    + [Function argument resolution](#function-argument-resolution)
    + [Vaargs](#vaargs)
  * [Asm block statement](#asm-block-statement)
  ...
  * [Compile time echo statement](#compile-time-echo-statement)
    + [The message](#the-message)
  * [Compile time assert statement](#compile-time-assert-statement)
    + [Evaluated expression](#evaluated-expression)
    + [Error message](#error-message)
  * [Compile time error statement](#compile-time-error-statement)
    + [Error message](#error-message-1)
  * [Compile time if statement](#compile-time-if-statement)
    + [Cond expression](#cond-expression)
    + [Scopes](#scopes)
    + [Evaluation](#evaluation)
  * [Compile time switch statement](#compile-time-switch-statement)
    + [No cond expression switch](#no-cond-expression-switch)
    + [Type expressions](#type-expressions)
    + [Ranged cases](#ranged-cases)
    + [Fallthrough](#fallthrough)
    + [Break and nextcase](#break-and-nextcase)
    + [Evaluation of statements](#evaluation-of-statements)
  * [Continue statement](#continue-statement)
    + [Continue labels](#continue-labels)
    + [Unreachable code](#unreachable-code-1)
  * [Declaration statement](#declaration-statement)
    ...
    + [No init expression](#no-init-expression)
    + [Opt-out of zero initialization](#opt-out-of-zero-initialization)
    + [Self referencing initialization](#self-referencing-initialization)
  * [Defer statement](#defer-statement)
    + [Defer in defer](#defer-in-defer)
    + [Static and tlocal variables in defer](#static-and-tlocal-variables-in-defer)
    + [Defer and return](#defer-and-return)
    + [Defer and jump statements](#defer-and-jump-statements)
    + [Defer execution](#defer-execution)
    + [`defer try`](#defer-try)
    + [`defer catch`](#defer-catch)
    + [Non-regular returns - longjmp, panic and other errors](#non-regular-returns---longjmp-panic-and-other-errors)
  * [Expr statement](#expr-statement)
    + [No discard](#no-discard)
  * [If statement](#if-statement)
    + [Scopes](#scopes-2)
    + [Special parsing of the "then" clause](#special-parsing-of-the-then-clause)
    + [Break](#break)
    + [If-try](#if-try)
    + [If-catch](#if-catch)
    + [If-catch implicit unwrap](#if-catch-implicit-unwrap)
  * [Nextcase statement](#nextcase-statement)
    + [Labels](#labels)
    + [No expression jumps](#no-expression-jumps)
    + [Jumps to default](#jumps-to-default)
    + [Missing case](#missing-case)
    + [Variable expression](#variable-expression)
    + [Unreachable code](#unreachable-code-2)
  * [Switch statement](#switch-statement)
    + [Regular switch](#regular-switch)
    + [If-switch](#if-switch)
    + [Any-switch](#any-switch)
    + [Ranged cases](#ranged-cases-1)
    + [Fallthrough](#fallthrough-1)
    + [Exhaustive switch](#exhaustive-switch)
    + [Break](#break-1)
    + [Unreachable code](#unreachable-code-3)
    + [Switching over typeid](#switching-over-typeid)
    + [Nextcase without expression](#nextcase-without-expression)
    + [Nextcase with expression](#nextcase-with-expression)
    + [Do statement](#do-statement)
    + [Unreachable code](#unreachable-code-4)
    + [Break](#break-2)
    + [Continue](#continue)
    + [Do block](#do-block)
  * [For statement](#for-statement)
    + [Init expression](#init-expression)
    + [Incr expression](#incr-expression)
    + [Cond expression](#cond-expression-1)
    + [Unreachable code](#unreachable-code-5)
    + [Break](#break-3)
    + [Continue](#continue-1)
    + [Equivalence of `while` and `for`](#equivalence-of-while-and-for)
  * [`foreach` and `foreach_r` statements](#foreach-and-foreach_r-statements)
    + [Break](#break-4)
    + [Continue](#continue-2)
    + [Iteration by value or reference](#iteration-by-value-or-reference)
    + [Foreach variable](#foreach-variable)
    + [Foreach index](#foreach-index)
    + [Foreach support](#foreach-support)
  * [Return statement](#return-statement)
    + [Jumps in return statements](#jumps-in-return-statements)
    + [Empty returns](#empty-returns)
    + [Unreachable code](#unreachable-code-6)
  * [While statement](#while-statement)
    + [Unreachable code](#unreachable-code-7)
    + [Break](#break-5)
    + [Continue](#continue-3)
  * [Var statement](#var-statement)
    + [Inferring type](#inferring-type)
    + [Scope](#scope)
...
- [Methods](#methods)
    + [Operator overloading](#operator-overloading)
      ...
      - [Reference indexing operator (`&[]`)](#reference-indexing-operator-)
      - [Assigning index operator (`=[]`)](#assigning-index-operator-)
      - [Len operator (`len`)](#len-operator-len)
